...
class TodoListModel extends ChangeNotifier {
  List<Task> todos = [];
  bool isLoading = true;
  final String _rpcUrl = 'http://192.168.43.60:7545';
  final String _wsUrl = 'ws://192.168.43.60:7545/';

  final String _privateKey =
      '8eba7092afc92f5b7528d1a034720d12c6020eeb86537ad62b59a030b416817c';
  ...
  Future<void> getAbi() async {
    String abiStringFile =
        await rootBundle.loadString("scr/abis/TodoList.json");
